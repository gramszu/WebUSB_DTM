...
#define CMD_POLL_DEVICE 'P'   // Polling identyfikacji urządzenia (v250)
#define CMD_GET_ID 'I'        // Jawny odczyt identyfikacji (v250)

/* Protokół konfiguratora */
#define CONFIG_PROTOCOL_VERSION 250
#define CONFIG_PROTOCOL_VERSION_STR "250"
#define CONFIG_DEVICE_ID "AC250"
