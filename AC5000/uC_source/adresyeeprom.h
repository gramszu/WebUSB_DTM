...
// ============================================================================
// SEKCJA 2: NUMERY TELEFONÓW (0x0008 - ok. 25 KB przy 5000 numerach)
// ============================================================================
...
// 5000 numerów: 5000 * 5 = 25000 bajtów (ok. 24.4 KB). Wymaga zewn. EEPROM
// (AT24C512).
#define MAX_LICZBA_NUMEROW_TELEFONOW_BRAMA 5000
#define MAX_LICZBA_NUMEROW_TELEFONOW_BRAMA_USER 5000

// Koniec bloku numerów: 8 + (5000 * 5) - 1 = 25007. Konfiguracja od 25008.
#define ADRES_EEPROM_CLIP_DURATION 25008 // 4 bajty: 25008-25011
#define ADRES_EEPROM_CLIP_TOGGLE 25012   // 1 bajt

// ============================================================================
// SEKCJA 3: KONFIGURACJA SYSTEMU
// ============================================================================

#define ADRES_EEPROM_TRYB_PRACY 25013      // 1 bajt
#define ADRES_EEPROM_TRYB_CLIP_DTMF 25014  // 1 bajt (0=DTMF, 1=CLIP)
#define ADRES_EEPROM_BLOKADA_SYSTEMU 25015 // 1 B (RESERVED)
#define ADRES_EEPROM_LICZNIK_CYKLI 25016   // 4 bajty Little Endian: 25016-25019
#define ADRES_EEPROM_CON_NUMER 25020       // 5 bajtów: 25020-25024

// ============================================================================
// SEKCJA 4: USTAWIENIA (rezerwa na przyszłe opcje, powiadomienia, itp.)
// ============================================================================
#define ADRES_EEPROM_USTAWIENIA_START 25025
#define ADRES_EEPROM_INIT_FLAG 25025   // 1 bajt (Magic Byte 0xA5)
...
// Razem: numery 24.4 KB + konfig 20 B + ustawienia 1 KB ≈ 25.4 KB
