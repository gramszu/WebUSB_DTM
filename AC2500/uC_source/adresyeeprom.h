...
// ============================================================================
// SEKCJA 2: NUMERY TELEFONÓW (0x0008 - ok. 10 KB przy 2000 numerach)
// ============================================================================
...
// 2500 numerów: 2500 * 5 = 12500 bajtów (ok. 12.2 KB). Wymaga zewn. EEPROM
// (AT24C512).
#define MAX_LICZBA_NUMEROW_TELEFONOW_BRAMA 2500
#define MAX_LICZBA_NUMEROW_TELEFONOW_BRAMA_USER 2500

// Koniec bloku numerów: 8 + (2500 * 5) - 1 = 12507. Konfiguracja od 12508.
#define ADRES_EEPROM_CLIP_DURATION 12508 // 4 bajty: 12508-12511
#define ADRES_EEPROM_CLIP_TOGGLE 12512   // 1 bajt

// ============================================================================
// SEKCJA 3: KONFIGURACJA SYSTEMU
// ============================================================================

#define ADRES_EEPROM_TRYB_PRACY 12513      // 1 bajt
#define ADRES_EEPROM_TRYB_CLIP_DTMF 12514  // 1 bajt (0=DTMF, 1=CLIP)
#define ADRES_EEPROM_BLOKADA_SYSTEMU 12515 // 1 B (RESERVED)
#define ADRES_EEPROM_LICZNIK_CYKLI 12516   // 4 bajty Little Endian: 12516-12519
#define ADRES_EEPROM_CON_NUMER 12520       // 5 bajtów: 12520-12524

// ============================================================================
// SEKCJA 4: USTAWIENIA (rezerwa na przyszłe opcje, powiadomienia, itp.)
// ============================================================================
#define ADRES_EEPROM_USTAWIENIA_START 12525
#define ADRES_EEPROM_INIT_FLAG 12525   // 1 bajt (Magic Byte 0xA5)
...
// Razem: numery 10 KB + konfig 20 B + ustawienia 1 KB ≈ 11 KB
